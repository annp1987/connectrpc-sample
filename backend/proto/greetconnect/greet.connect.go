...
import (
	...
	context "context"
	errors "errors"
	proto "github.com/annp1987/sms-app/proto"
	http "net/http"
	strings "strings"
)
...
var (
	greetServiceServiceDescriptor     = proto.File_greet_proto.Services().ByName("GreetService")
...
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[proto.SMSAnalysisRequest]) (*connect.Response[proto.SMSAnalysisResponse], error)
}
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		greet: connect.NewClient[proto.SMSAnalysisRequest, proto.SMSAnalysisResponse](
			httpClient,
...
type greetServiceClient struct {
	greet *connect.Client[proto.SMSAnalysisRequest, proto.SMSAnalysisResponse]
}

// Greet calls greet.GreetService.Greet.
func (c *greetServiceClient) Greet(ctx context.Context, req *connect.Request[proto.SMSAnalysisRequest]) (*connect.Response[proto.SMSAnalysisResponse], error) {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[proto.SMSAnalysisRequest]) (*connect.Response[proto.SMSAnalysisResponse], error) {
